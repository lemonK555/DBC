											...
											<div id="member-tab" class="tab-pane">
												<div class="clearfix">
													<div class="itemdiv memberdiv">
														<div class="user">
															<img alt="Bob Doe's avatar" src="${basePath}page/assets/avatars/user.jpg" />
														</div>
													...
													<div class="itemdiv memberdiv">
														<div class="user">
															<img alt="Joe Doe's avatar" src="${basePath}page/assets/avatars/avatar2.png" />
														</div>
													...
													<div class="itemdiv memberdiv">
														<div class="user">
															<img alt="Jim Doe's avatar" src="${basePath}page/assets/avatars/avatar.png" />
														</div>
													...
													<div class="itemdiv memberdiv">
														<div class="user">
															<img alt="Alex Doe's avatar" src="${basePath}page/assets/avatars/avatar5.png" />
														</div>
													...
													<div class="itemdiv memberdiv">
														<div class="user">
															<img alt="Bob Doe's avatar" src="${basePath}page/assets/avatars/avatar2.png" />
														</div>
													...
													<div class="itemdiv memberdiv">
														<div class="user">
															<img alt="Susan's avatar" src="${basePath}page/assets/avatars/avatar3.png" />
														</div>
													...
													<div class="itemdiv memberdiv">
														<div class="user">
															<img alt="Phil Doe's avatar" src="${basePath}page/assets/avatars/avatar4.png" />
														</div>
													...
													<div class="itemdiv memberdiv">
														<div class="user">
															<img alt="Alexa Doe's avatar" src="${basePath}page/assets/avatars/avatar1.png" />
														</div>
											...
											<div id="comment-tab" class="tab-pane">
												<div class="comments">
													<div class="itemdiv commentdiv">
														<div class="user">
															<img alt="Bob Doe's Avatar" src="${basePath}page/assets/avatars/avatar.png" />
														</div>
													...
													<div class="itemdiv commentdiv">
														<div class="user">
															<img alt="Jennifer's Avatar" src="${basePath}page/assets/avatars/avatar1.png" />
														</div>
													...
													<div class="itemdiv commentdiv">
														<div class="user">
															<img alt="Joe's Avatar" src="${basePath}page/assets/avatars/avatar2.png" />
														</div>
													...
													<div class="itemdiv commentdiv">
														<div class="user">
															<img alt="Rita's Avatar" src="${basePath}page/assets/avatars/avatar3.png" />
														</div>
									...
									<div class="widget-main no-padding">
										<div class="dialogs">
											<div class="itemdiv dialogdiv">
												<div class="user">
													<img alt="Alexa's Avatar" src="${basePath}page/assets/avatars/avatar1.png" />
												</div>
											...
											<div class="itemdiv dialogdiv">
												<div class="user">
													<img alt="John's Avatar" src="${basePath}page/assets/avatars/avatar.png" />
												</div>
											...
											<div class="itemdiv dialogdiv">
												<div class="user">
													<img alt="Bob's Avatar" src="${basePath}page/assets/avatars/user.jpg" />
												</div>
											...
											<div class="itemdiv dialogdiv">
												<div class="user">
													<img alt="Jim's Avatar" src="${basePath}page/assets/avatars/avatar4.png" />
												</div>
...
<jsp:include page="allManage2.jsp"/>				
	...
	<script src="${basePath}page/assets/js/jquery-ui-1.10.3.custom.min.js"></script>
	<script src="${basePath}page/assets/js/jquery.ui.touch-punch.min.js"></script>
	<script src="${basePath}page/assets/js/jquery.slimscroll.min.js"></script>
	<script src="${basePath}page/assets/js/jquery.easy-pie-chart.min.js"></script>
	<script src="${basePath}page/assets/js/jquery.sparkline.min.js"></script>
	<script src="${basePath}page/assets/js/flot/jquery.flot.min.js"></script>
	<script src="${basePath}page/assets/js/flot/jquery.flot.pie.min.js"></script>
	<script src="${basePath}page/assets/js/flot/jquery.flot.resize.min.js"></script>
