...
<div class="row">
	<div class="col-xs-12">
		<div class="widget-header">
			<div class="col-sm-10">
				<h4>黑名单
				<input type="text" id="findName" style="margin-left:20px;">
				<a id="search" href="" title="搜索" >	
		...
		<div class="table-responsive">
			<table id="sample-table-1" class="table table-striped table-bordered table-hover">
				...
				<tbody>
					<c:forEach items="${userForms}" var="p" varStatus="currentStatus">
						<tr>
							<td class="center">
								<label>
									<input type="checkbox" class="ace" />
							...
							<td>
								<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
									<a class="green" href="${basePath}user/delUserInBlackList?userName=${p.userName}" title="移出黑名单">
										<i class="icon-remove-sign bigger-100"></i>
									</a>
									<a class="red" href="#" title="删除">	
										<i class="icon-trash bigger-100 red"></i>
									</a>
								</div>						
							</td>
						</tr>
